<script>
  import LoginView from "$lib/views/login/view.svelte";
...
{/if}
{#key $pagination}
  <div out:fade={{duration:100}} in:fly="{{y:-100, delay:200}}" class="top-0 left-0 absolute w-full h-full bg-white flex flex-col">

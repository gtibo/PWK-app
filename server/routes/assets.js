...
const {
  ...
  assetImageIDToData,
  assetImagesList
} = require(path.resolve(__dirname, "./asset_util.js"));


// Get all asset data
router.get('/all/:asset_type?', function(req, res, next) {
  try {
    let assets = getAll(req.params.asset_type);
